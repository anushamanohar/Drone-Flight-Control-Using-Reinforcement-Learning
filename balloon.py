...
from player import SACPlayer
from player import TD3Player
from player import A2CPlayer
...
def balloon(players):
    ...
    print("Screen created:", screen)

    print("Pygame initialized:", pygame.get_error())
    ...
    players = [PIDPlayer(), SACPlayer(), TD3Player(), A2CPlayer(), PPOPlayer()]
